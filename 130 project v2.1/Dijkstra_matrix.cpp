...
{
	// car 30 cents a mile, 45 miles/h
	// bus 15 cents a mile, 30 miles/h
	double car_cost_money = track_distance[end_city] * 0.3;
	...
	std::cout << "Car use: \n$" << car_cost_money << " Time: " << car_cost_time << " mins" << std::endl;
	std::cout << "Bus use: \n$" << bus_cost_money << " Time: " << bus_cost_time << " mins" << std::endl;
}